const tarefas = [
    { id: 1739220546861, nome: "Estudar JavaScript",
concluida: false}
];
...
function modificarTarefa(idTarefa, tarefaModificada) {
    const tarefaLocalizada = tarefas.find(tarefa => parseInt(tarefa.id) 
    === parseInt (idTarefa));
    if (tarefaLocalizada) {
...
export { listarTarefas, adicionarTarefa, removerTarefa,
     modificarTarefa}
